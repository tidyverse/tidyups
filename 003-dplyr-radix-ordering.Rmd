...
On certain systems, stringi can be a difficult dependency to install. Because of this, this proposal recommends that stringi only be _suggested_ so that users without stringi can still use dplyr.
