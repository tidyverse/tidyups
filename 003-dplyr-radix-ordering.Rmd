...
On certain systems, stringi can be a difficult dependency to install. Because of this, this proposal recommends that stringi be a suggested dependency of dplyr, to ensure that users without access to stringi can still use dplyr.
