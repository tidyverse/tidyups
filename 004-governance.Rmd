...
To on-board a new author, the maintainer looks for rough consensus amongst authors by emailing them (since this needs to be done in private).
(one signal of rough consensus would be no objections within 7 days).
