...
There are relatively few difference between regexp engines, but you need a very different syntax to control options (e.g. ignoring case).
...
We don't need to consider compound problems that need to be solved by splitting into rows and columns simultaneously because you a compound problem (e.g. `"a-b-c/d-e-f/g-h-i"`) can always be solved it by first splitting into rows and then into columns.
